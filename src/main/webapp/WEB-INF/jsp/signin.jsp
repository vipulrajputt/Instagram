          ...
          <div class="w-100 py-5 px-md-5 px-xl-6 position-relative">
            ...
            <form action="studentlog" modelAttribute="studentlogin" method="POST" class="form-validate">
              <div class="form-group">
               <input type="text" id="name" aria-describedby="" autocomplete="off" placeholder="Phone number, username, or email" aria-required="true" maxlength="30" autocapitalize="off" autocorrect="off" class="form-control" name="username" value="" required> 
               </div>
              <div class="form-group">
                  <input type="password" name="password" id="password" placeholder="Password" aria-describedby="" maxlength="30" aria-required="true" autocapitalize="off" autocorrect="off" required class="form-control"/>
              </div>
              <!-- Submit-->
              <button class="btn btn-lg btn-block btn-secondary">Sign in</button>
              <button class="btn btn-lg btn-block textinsta">Forget Password?</button>
            </form><a href="index.jsp" class="close-absolute mr-md-5 mr-xl-6 pt-5"> 
              <svg class="svg-icon w-3rem h-3rem" style="color:black">
                <use xlink:href="#close-1"> </use>
              </svg></a>
            <p class="textinsta">Don't Have an account? <a href="index.jsp">Sign up</a></p>
          </div>
        </div>
      </div>
    </div>
